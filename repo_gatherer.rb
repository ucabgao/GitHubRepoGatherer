...
TOKEN = '6e3a5ffcd40df29682c41f893c6ce00b76d20b66' # Generated by GitHub, use your own
...
class RepoGatherer
  ...
  def estimate_page_number
    ...
    # GitHub rate limit, 20 queries per minute
    sleep 20
  end
  ...
  def build_url(keyword, opts = {})
    ...
    search_url =
        URL_PREFIX + search_term + SEARCH_TERMS + SEARCH_PARAMETERS + "&page=#{page.to_s}"
  end
